...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "rounded-3xl border border-emerald-100/90 bg-white/90 text-slate-950 shadow-[0_18px_35px_-24px_rgba(6,95,70,0.65)] backdrop-blur transition-transform duration-200 hover:-translate-y-0.5",
        className,
      )}
      {...props}
    />
...
function CardDescription({
  ...
  return (
    <p
      ...
      className={cn("text-sm text-slate-700/90", className)}
      {...props}
    />
  );
}
